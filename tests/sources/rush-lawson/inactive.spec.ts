...
// RUSH Lawson — Inactive
// Field list and highlights from Rush_Lawson_Inactive.pdf (RL-981490002TESTCL000PD).
//   npx playwright test tests/sources/rush-lawson/inactive.spec.ts --headed
const STAGE_KEY = 'RL-981490002TESTCL000PD';
...
const INACTIVE_RUSH_ACCOUNT_FIELDS = [
  'Name',
  'Native Identity',
  'Identity',
  'Source Name',
...
test('RUSH Lawson — Inactive', async ({ page }) => {
  await runSourceLifecycle(page, RUSH_SOURCE, 'inactive', STAGE_KEY, {
    searchHighlightTexts: ['JDBC', 'Disabled'],
    highlightIdentityOnAccess: true,
    detailFields: INACTIVE_DETAIL_FIELDS,
    accountDetailFields: INACTIVE_RUSH_ACCOUNT_FIELDS,
