...
// Non-Employee Workforce — Active
// Field list and highlights from Non-Employee_workforce_Active.pdf (NE-19825552TEST000PDPPL).
//   npx playwright test tests/sources/nerm/active.spec.ts --headed
const STAGE_KEY = 'NE-19825552TEST000PDPPL';
...
const ACTIVE_NERM_ACCOUNT_FIELDS = [
  'Name',
  'Native Identity',
  'Identity',
  'Source Name',
...
test('Non-Employee Workforce — Active', async ({ page }) => {
  await runSourceLifecycle(page, NERM_SOURCE, 'active', STAGE_KEY, {
    searchHighlightTexts: ['JDBC', 'Enabled'],
    highlightIdentityOnAccess: true,
    detailFields: ACTIVE_DETAIL_FIELDS,
    accountDetailFields: ACTIVE_NERM_ACCOUNT_FIELDS,
